  ...
  return (
    <div className="container mx-auto pt-10 pb-16 px-5">
      <div className="sm:w-3/5 lg:min-h-[70vh] rounded-[3rem] shadow-md mx-auto lg:flex">
        <div className="lg:w-1/2 px-5 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-t-[3rem] lg:rounded-r-none lg:rounded-l-[3rem] flex flex-col py-8 items-center justify-center">
